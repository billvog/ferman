...
const TermsOfService = ({}) => {
  return (
    <Layout title="Terms of Service – Ferman" size="2xl">
      <div>
        <h1 className="heading">Terms and Conditions of Use</h1>
        <div className="space-y-4">
          <div>
            <h3 className="font-bold text-lg">1. Terms</h3>
            <div>
              By accessing this Website, accessible from https://ferman.ga, you
          ...
          <div>
            <h3 className="font-bold text-lg">2. Use License</h3>
            <div>
              Permission is granted to temporarily download one copy of the
              materials on Ferman's Website for personal, non-commercial
          ...
          <div>
            <h3 className="font-bold text-lg">3. Disclaimer</h3>
            <div>
              ...
              negates all other warranties. Furthermore, Ferman does not make
          ...
          <div>
            <h3 className="font-bold text-lg">4. Limitations</h3>
            <div>
              Ferman or its suppliers will not be hold accountable for any
              damages that will arise with the use or inability to use the
              materials on Ferman’s Website, even if Ferman or an authorize
          ...
          <div>
            <h3 className="font-bold text-lg">5. Revisions and Errata</h3>
            <div>
              The materials appearing on Ferman’s Website may include technical,
              typographical, or photographic errors. Ferman will not promise
              that any of the materials in this Website are accurate, complete,
              or current. Ferman may change the materials contained on its
              Website at any time without notice. Ferman does not make any
              commitment to update the materials.
            </div>
          </div>
          <div>
            <h3 className="font-bold text-lg">6. Links</h3>
            <div>
              Ferman has not reviewed all of the sites linked to its Website and
              is not responsible for the contents of any such linked site. The
              presence of any link does not imply endorsement by Ferman of the
          ...
          <div>
            <h3 className="font-bold text-lg">8. Governing Law</h3>
            <div>
              Any claim related to Ferman's Website shall be governed by the
              laws of gr without regards to its conflict of law provisions.
            </div>
          </div>
        </div>
      </div>
...
export default withMyApollo()(TermsOfService);
