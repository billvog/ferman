...
export declare const USER_UID_SHAPE: import("yup/lib/string").RequiredStringSchema<string | undefined, Record<string, any>>;
export declare const USER_USERNAME_SHAPE: import("yup/lib/string").RequiredStringSchema<string | undefined, Record<string, any>>;
export declare const USER_EMAIL_SHAPE: import("yup/lib/string").RequiredStringSchema<string | undefined, Record<string, any>>;
export declare const USER_BIRTHDATE_SHAPE: yup.DateSchema<Date | undefined, Record<string, any>, Date | undefined>;
export declare const USER_PASSWORD_SHAPE: import("yup/lib/string").RequiredStringSchema<string | undefined, Record<string, any>>;
